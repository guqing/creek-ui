        ...
        children: [
          {
            ...
            meta: { title: '用户管理', keepAlive: true, authority: ['read:user'] },
          },
          {
            name: 'Role',
            path: '/ram/role',
            component: () => import('@/views/role/RoleList'),
            meta: { title: '角色管理', keepAlive: true, authority: ['read:role'] },
          },
          {
            name: 'UserGroup',
            path: '/ram/user/group',
            component: () => import('@/views/group/UserGroupList'),
            meta: { title: '用户组', keepAlive: true, authority: ['read:group'] },
          },
        ],
      },
      {
